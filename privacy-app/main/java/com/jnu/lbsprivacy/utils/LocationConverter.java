...
public class LocationConverter {
    ...
    public static LatLng gcj02Decrypt(double gjLat, double gjLon) {
        ...
        return new LatLng(gjLat - dLat, gjLon - dLon);
    }
    ...
    public static LatLng bd09Encrypt(double ggLat, double ggLon) {
        ...
        double z = Math.sqrt(x * x + y * y) + 0.00002 * Math.sin(y * Math.PI);
        double theta = Math.atan2(y, x) + 0.000003 * Math.cos(x * Math.PI);
        double bdPt_longitude = z * Math.cos(theta) + 0.0065;
        double bdPt_latitude = z * Math.sin(theta) + 0.006;
        return new LatLng(bdPt_latitude, bdPt_longitude);
    }
